...
import {CANVAS_WIDTH, GOAL_CONSTANTS, world} from "./sketch.js";
...
class Goal {
  constructor(options) {
    ...
    this.areaWidth =
      "areaWidth" in options ? options.areaWidth : GOAL_CONSTANTS.AREA_WIDTH;
    this.areaHeight =
      "areaHeight" in options ? options.areaHeight : GOAL_CONSTANTS.AREA_HEIGHT;
    this.topBarX =
      "topBarX" in options ? options.topBarX : GOAL_CONSTANTS.TOPBAR_POS_X;
    this.topBarY =
      "topBarY" in options ? options.topBarY : GOAL_CONSTANTS.TOPBAR_POS_Y;
    this.topBarW =
      "topBarWidth" in options
        ? options.topBarWidth
        : GOAL_CONSTANTS.TOPBAR_WIDTH;
    this.topBarH =
      "topBarHeight" in options
        ? options.topBarHeight
        : GOAL_CONSTANTS.TOPBAR_HEIGHT;
    this.botBarX =
      "bottomBarX" in options
        ? options.bottomBarX
        : GOAL_CONSTANTS.BOTTOMBAR_POS_X;
    this.botBarY =
      "bottomBarY" in options
        ? options.bottomBarY
        : GOAL_CONSTANTS.BOTTOMBAR_POS_Y;
    this.botBarW =
      "bottomBarWidth" in options
        ? options.bottomBarWidth
        : GOAL_CONSTANTS.BOTTOMBAR_WIDTH;
    this.botBarH =
      "bottomBarHeight" in options
        ? options.bottomBarHeight
        : GOAL_CONSTANTS.BOTTOMBAR_HEIGHT;
